...
def get_finance(table, fn_body, code, case):
    try:
        ...
        # # Table = Table.append(Table) / 원하는 기간만 가져오기
        # if case == 'year':
        #     Table = Table.loc[Table.year.isin(['2016/12', '2017/12', '2018/12', '2019/12', '2020/12(E)'])]  #isin구문으로 list안쪽에 있는 구분 걸려내기.
        # else:
        #     Table = Table.loc[Table.year.isin(['2019/09', '2019/12', '2020/03', '2020/06', '2020/09', '2020/12(E)'])]
        ...
        print('get_finance_error detection!')
    ...
    try:
        ...
        for i in range(1, 3):
            if i == 1:
                ...
                Table_year = get_finance(table, fn_body, code, 'year')

            else:
                table = ur_table.find('div', {'id': 'highlight_D_Q'})
                Table_quarter = get_finance(table, fn_body, code, 'quarter')
