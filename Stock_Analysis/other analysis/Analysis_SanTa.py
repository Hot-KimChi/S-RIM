...
select 
    ...
    , main_product
    , 시가총액_억
    , ROUND(cash_202006 * 2 / 시가총액_억, 2) as ratio
    , cash_202006
    , cash_201912
    , cash_201812
    , cash_201712
...
(
    ...
    ,b.main_product
    ,c.시가총액_억
    , (case when inx = 1 then 영업활동으로인한현금흐름 else 0 end) as cash_202006
    , (case when inx = 2 then 영업활동으로인한현금흐름 else 0 end) as cash_201912
    , (case when inx = 3 then 영업활동으로인한현금흐름 else 0 end) as cash_201812
    , (case when inx = 4 then 영업활동으로인한현금흐름 else 0 end) as cash_201712   
...
result_stock = data.rename(columns={0 : 'Code', 1 : 'Name', 2 : 'Industry', 3 : 'Main_product', 4 : '시가총액_억', 5 : 'Ratio',
                                    6 : '영업활동&현금_202006', 7 : '영업활동&현금_201912', 8 : '영업활동&현금_201812',
                                    9 : '영업활동&현금_201712'})

result_stock.to_csv(f'Result_SanTa_{date}.csv', encoding='utf-8-sig')
