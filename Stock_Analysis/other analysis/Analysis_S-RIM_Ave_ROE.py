...
select 
    ...
    then ROUND((main_price  + main_price * ((3*roe_19 + 2*roe_past_2 + 1*roe_past_3) / 6/100 - discount_rate/100) * (0.8 / (1 + discount_rate/100 - 0.8))) * 100000000 / distribute_stock) 
    ...
    , case when roe_20e <= discount_rate 
    then ROUND((main_price  + main_price * ((3*roe_19 + 2*roe_past_2 + 1*roe_past_3) / 6/100 - discount_rate/100) * (0.9 / (1 + discount_rate/100 - 0.9))) * 100000000 / distribute_stock) 
    ...
    , case when roe_20e <= discount_rate 
    then ROUND((main_price  + main_price * ((3*roe_19 + 2*roe_past_2 + 1*roe_past_3) / 6/100 - discount_rate/100) / (discount_rate/100)) * 100000000 / distribute_stock) 
    ...
    , case when roe_20e <= discount_rate 
    then ROUND((main_price  + main_price * ((3*roe_19 + 2*roe_past_2 + 1*roe_past_3) / 6/100 - discount_rate/100) * (0.8 / (1 + discount_rate/100 - 0.8))) * 100000000 / distribute_stock / end_price, 2) 
    ...
    , case when roe_20e <= discount_rate 
    then ROUND((main_price  + main_price * ((3*roe_19 + 2*roe_past_2 + 1*roe_past_3) / 6/100 - discount_rate/100) / (discount_rate/100)) * 100000000 / distribute_stock / end_price, 2) 
...
result_stock.to_csv(f'Result_S-RIM_Ave_ROE_{date}.csv', encoding='utf-8-sig')
